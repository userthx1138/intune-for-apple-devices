...
The following pages give high level level directions for setting up  
Intune with basic Mac management capabilities.

It is assumed that you are already familiar with Intune and have  
existing Intune and Apple Business Manager instances set up and have  
logins with sufficient privilege to carry out the operations required.
...
Navigate to **Devices -> iOS/iPadOS -> iOS/iPadOS Enrollmen**
...
![](/images/DYQ8Ta8mgLkWG.png)

![image](https://media.github.pie.apple.com/user/55378/files/335f521f-1f77-492f-822f-438bc5300f93)
...
<img src="./images/0U9jAlaGcu9Vw.png" alt="" data-align="left"/>
...
<img src="./images/tSlGZEiBOTHGx.png" alt="" data-align="left"/>
...
![](./images/ckbr88YtyUFJT.png)



UUnder **Assignments** click **+Add all devices**
...
This can be done with a text editor or a tool like iMazing Profile editor.

![](./images/gYahUWBiFhKgU.png)
...
Download the latest version of the SAP Privileges tools from [https://github.com/SAP/macOS-enterprise-privileges](https://github.com/SAP/macOS-enterprise-privileges)

On a Mac install Privileges in the Applications folder

On a Mac install Privileges in the Applications folder

Use the Packages App ([http://s.sudre.free.fr/Software/Packages/about.html](http://s.sudre.free.fr/Software/Packages/about.html)) to create a file called `Privileges.pkg`
...
![](./images/jPR2IxCjwYLSp.png)

![](./images/uKuhESxdNJIe3.png)
...
Create the .pkg file using a tool such as Packages from Whitebox. Include a post install script with the following content:
...
*The user would normally be prompted to approve the MDM Agent setting the Wallpaper so we deploy a PPPC Profile. This can be created using the* ***Jamf PPPC Utility.*** 

![](./images/l8ijJoc7qbcFt.png)
...
Upload the Custom Configuration profile file. Use filename `IntunePPPC.mobileconfig` (contents below)
...
<img src="./images/Hk2FJRLFPSLdr.png" alt="" data-align="left"/>
...
Click **+ Add settings** and choose **Security -> Passcode ->** ***<Needed Settings>*** 

![](./images/l9aGkXT9CmjXt.png)
...
[macOS Configuration - See Settings for macOS](https://learn.microsoft.com/en-us/mem/intune/configuration/)macOS Configuration - See Settings for macOS**macOS Configuration - See Settings for macOS**
